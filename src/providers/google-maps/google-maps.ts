...
export class GoogleMapsProvider {
  ...
  currentMarker: any;
  apiKey: string = "AIzaSyCIcNOFRzUaY-ApJIdHlNj8RwrAniGZZTY	";
    ...
    return new Promise((resolve) => {
      ...
      if(typeof google == "undefined" || typeof google.maps == "undefined"){
        ...
        if(this.connectivityService.isOnline()){
          ...
          if(this.apiKey){
            script.src = 'http://maps.google.com/maps/api/js?key=' + this.apiKey + '&callback=mapInit&libraries=places&sensor=true';
          } else {
